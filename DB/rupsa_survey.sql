...
-- Dumping structure for table rupsa_survey.acls
...
-- Dumping structure for table rupsa_survey.asset_types
...
-- Dumping data for table rupsa_survey.asset_types: ~8 rows (approximately)
...
-- Dumping data for table rupsa_survey.users: ~2 rows (approximately)
DELETE FROM `users`;
