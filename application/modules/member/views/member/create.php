...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="nid" class="col-sm-2 control-label">Date Of Birth :</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="date_of_birth" id="nid" placeholder="NID" value="<?php echo $nid; ?>" />
                    <?php echo form_error('nid') ?>
                </div>
            </div>
            <div class="form-group">
                <label for="social_security_benefit_id" class="col-sm-2 control-label">খানা প্রধানের সম্পদের ধরন :</label>
                <div class="col-sm-10">
