...
<section class="content-header">
    <h1> Division  <small><?php echo $button ?></small> <a href="<?php echo site_url( Backend_URL .'union/division') ?>" class="btn btn-default">Back</a> </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo Backend_URL ?>"><i class="fa fa-dashboard"></i> Admin</a></li>
	<li><a href="<?php echo Backend_URL ?>union">Union</a></li>
	<li><a href="<?php echo Backend_URL ?>union/division">Division</a></li>
...
<section class="content">       
	...
	<div class="col-md-10 col-md-offset-2" style="padding-left:5px;">
	    ...
	    <a href="<?php echo site_url( Backend_URL .'union/division') ?>" class="btn btn-default">Cancel</a>
	</div>
	<?php echo form_close(); ?>
	</div>
</div>
