...
<section class="content-header">
    <h1> Upazila  <small><?php echo $button ?></small> <a href="<?php echo site_url( Backend_URL .'union/upazila') ?>" class="btn btn-default">Back</a> </h1>
    <ol class="breadcrumb">
...
<section class="content">       
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Add New Upazila</h3>
        </div>
